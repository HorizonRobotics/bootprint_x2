...
MACRO(INIT_DEPENDENCY_INFO)
  ...
  set(dep_file "${CMAKE_CURRENT_SOURCE_DIR}/dep.tmp")
  GETLINES(lines ${dep_file})

  foreach (line ${lines})
    set(INCLUDE_SEARCH_PATH "${CMAKE_CURRENT_SOURCE_DIR}/deps/${suffix}/${line}/include")
    set(LINK_SEARCH_PATH "${CMAKE_CURRENT_SOURCE_DIR}/deps/${suffix}/${line}/lib")
    message(STATUS "SET INCLUDE directories ${INCLUDE_SEARCH_PATH}")
    include_directories(${INCLUDE_SEARCH_PATH})
    message(STATUS "ADD HEADER SEARCH PATH:${INCLUDE_SEARCH_PATH}")
    message(STATUS "${LINK_SEARCH_PATH}")
