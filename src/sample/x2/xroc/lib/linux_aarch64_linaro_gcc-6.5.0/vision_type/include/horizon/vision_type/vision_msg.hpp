 ...
 *  @file hobot_vision_messages.h
 *  @brief this header file defines the vision related messages that are used in
...
struct Header {
  ...
  int64_t stamp_secs_;  // seconds
  int64_t stamp_nsecs_;  // nanoseconds
